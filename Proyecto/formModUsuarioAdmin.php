  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <ul>
        ...
        <div id="pagina">
      <h1 id="titulo_pagina"><span class="texto_titulo">Modificar usuario
      </span></h1>
	...
	mysqli_select_db($link, "48864593n");
		...
		if(!$sql){
			...
			echo "<a href='modUsuarioAdmin.php'>Regresar</a>";
		}else{
	...
	?>
	  ...
	  <form class='contacto' action="enviarModUsuarioAdmin.php" method="post">
           ...
           <div><label>Rol: <br /><select name="rol">
            ...
            <div><label>Teléfono:</label><input name='telefono' type='text' value='<?php echo $Telefono ?>'></div>
            <div><label>DNI:</label><input name='dni' type='text' value='<?php echo $DNI ?>'></div>
            <div><label>Despacho:</label><input name='despacho' type='text' value='<?php echo $desp ?>'></div>
