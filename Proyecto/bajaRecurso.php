  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
	...
	<head>
		<title>Profesor-Baja recurso</title>
    ...
    <ul>
        ...
        <div id="pagina">
      <h1 id="titulo_pagina"><span class="texto_titulo">Baja recurso</span></h1>
      <div id="contenido" class="sec_interior">
	<div class="content_doku">
	      <?php
		require_once('mostrarRecursos.php'); 
		$iden=new RecursosBD;
		$iden->mostrarRecursosID();
		?>     
            <form class='contacto' action="enviarBajaRecurso.php" method="post">
            <div><label>Introduzca ID a eliminar:</label><input name='IDRecurso' type='text' value=''></div>
