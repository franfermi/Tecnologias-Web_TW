<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
	...
	<body>
		...
		<div id="rastro">
          ...
          <div id="general">
        <div id="menus">
        <form class="widget_loginform" action="./identificacion.php" method="post" id="formulario">
...
<div id="enlaces_secciones" class="mod-menu_secciones">
    <ul>
        <li class="tipo2 item-first_level"><a href="monitor.php">Acceder al monitor</a></li>
        </ul>
</div>             
        </form>
        </div>
