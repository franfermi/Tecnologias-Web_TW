  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <ul>
        ...
        <div id="pagina">
      <h1 id="titulo_pagina"><span class="texto_titulo">Modificar usuario</span></h1>
      <div id="contenido" class="sec_interior">
	<div class="content_doku">
	      <?php
		require_once('mostrarRecursos.php'); 
		$iden=new RecursosBD;
		$iden->mostrarTablaLogin();
		?>
        <form class='contacto' action="formModUsuarioAdmin.php" method="post">
            <div><label>Introduzca email a modificar:</label><input name='email' type='text' value=''></div>
