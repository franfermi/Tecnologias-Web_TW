  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
	...
	<head>
		<title>Profesor-Alta recurso</title>
    ...
    <ul>
		...
		$iden=new RecursosBD;
		$codigo=$iden->generarCodigoRecurso();
		?>
        
        </div>
        <div id="pagina">
      <h1 id="titulo_pagina"><span class="texto_titulo">Alta recurso</span></h1>
      <div id="contenido" class="sec_interior">
	<div class="content_doku">
	  <form class='contacto' action="enviarAltaRecurso.php" method="post">
      		<div><label>ID:</label><input name='idRecurso' type='text' readonly="readonly" value='<?php echo $codigo ?>'></div>
            <div><label>Nombre recurso:</label><input name='nRecurso' type='text' value=''></div>
            <div><label>Nombre profesor:</label><input name='nProfesor' type='text' value=''></div>
            <div><label>Fecha inicio:</label><input name='fInicio' type='datetime-local' value=''></div>
            <div><label>Fecha fin:</label><input name='fFin' type='datetime-local' value=''></div>
            <div><label>Despacho:</label><input name='desp' type='text' value=''></div>
            <div><label>Descripción:</label><textarea name="descrip" rows='6'></textarea></div>
